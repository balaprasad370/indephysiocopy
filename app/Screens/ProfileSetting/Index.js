...
const Index = () => {
  ...
  const {isDark, setIsDark, setLoading} = appContext;
  ...
  return (
    <ScrollView style={style.settingScreen}>
      <View style={style.commonBackground}>
        <View style={style.commonTouch}>
        ...
        <TouchableOpacity style={style.commonTouch}>
          <View style={style.settingLeft}>
            ...
            <View style={style.userinfo}>
              <Text style={style.commonText}>Dinesh Tolani</Text>
