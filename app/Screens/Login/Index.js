...
//   const {isDark, setIsDark, setUserLogged, setLoading} = useContext(AppContext);
...
//         const token = await storage.setStringAsync(
//           'token',
...
//         setLoading(true);
//         // await storage.setItem('authToken', response.headers.authorization);
...
//         <View>
//           <AuthTitle authTitle="Welcome to IndiPhysio" />
