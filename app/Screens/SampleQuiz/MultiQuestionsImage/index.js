...
import ImageViewer from '../components/Image/index';
...
const MultiQuestionsNormal = ({
  ...
  const handleAnswerSelect = useCallback((subQuestionId, answer) => {
    onAnswerSelect(subQuestionId, answer);
  }, [onAnswerSelect]);

  const renderQuestion = useCallback((subQuestion, subIndex) => {
